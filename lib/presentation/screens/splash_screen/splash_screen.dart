...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _checkToken() async {
    // First: check version policy
    final result = await VersionService.checkForMandatoryUpdate();
    if (result.requiredUpdate) {
      // Navigate to mandatory update screen and stop further navigation
      Get.offAll(() => UpdateRequiredScreen(
    ...
    // Then proceed with existing splash delay and token check
          ...
          child: Column(
            children: [
              ...
              ErrorInfo(
                ...
                description:
                    "Kami sedang menyiapkan aplikasi untuk Anda. Mohon tunggu sebentar.",
          ...
          children: [
            ...
            button ??
                ElevatedButton(
                  ...
                  child: Text(btnText ?? "Coba Lagi".toUpperCase()),
                ),
            const SizedBox(height: 16),
          ],
        ),
